...
public class TouristAttractionFinder {
    ...
    /**
     * Constructor for TouristAttractionFinder, where the default hotel data will be loaded.
     * */
    public TouristAttractionFinder() {
        hdata = new ThreadSafeHotelData();
        hdata.loadHotelInfo("input/hotels.json");
    ...
    /**
     * */
    public String printFilteredAtrractions(String[] attractions, String hotelID) {
        String result = "";
