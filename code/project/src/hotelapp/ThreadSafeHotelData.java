...
public class ThreadSafeHotelData extends HotelData {
	...
	public boolean addReview(String hotelId, String reviewId, int rating, String reviewTitle, String review,
		...
		System.out.println("addReview enter");
		lock.lockWrite();
		try{
	...
	/**
	 * Override the super method getHotelsInReviewsMap
	 *
	 * @return a list of hotel id, which appears in the review map
	 * */
	@Override
	public List<String> getHotelsInReviewsMap(){
		lock.lockRead();
		try {
			return super.getHotelsInReviewsMap();
		} finally {
			lock.unlockRead();
		}
	}
	...
	public String handleAReviewFile(Path jsonFileName) {
		System.out.println("handle one review file");
//		lock.lockWrite();
		try {
...
//			lock.unlockWrite();
	...
	/**
	 * Override the super getHotelStreetAddress
	 *
	 * @param hotelID
	 *
	...
	public String getHotelStressAddress(String hotelID) {
		lock.lockRead();
		try {
			return super.getHotelStressAddress(hotelID);
		} finally {
			lock.unlockRead();
		}
	}
	...
	/**
	 * Override the super getOneHotelState.
	 *
	 * @param hotelID
	 *
	 * @return state
	...
	public String getOneHotelState(String hotelID) {
		lock.lockRead();
		try {
			return super.getOneHotelState(hotelID);
		} finally {
			lock.unlockRead();
		}
	}
	...
	/**
	 * Override the super getHotelFullAddress
	 *
	 * @param hotelId
	 *
	...
	public String getHotelFullAddress(String hotelId) {
		lock.lockRead();
		try {
			return super.getHotelFullAddress(hotelId);
		} finally {
			lock.unlockRead();
		}
	}
	...
	public double getRating(String hotelId) {
		lock.lockRead();
		try {
			return super.getRating(hotelId);
		} finally {
			lock.unlockRead();
		}
	}
	...
	/**
	 * Override the super getReviewsSizeOfOneHotel
	 *
	 * @param hotelID
	 *
	 * @return size
	...
	public int getReviewsSizeOfOneHotel(String hotelID) {
		lock.lockRead();
		try {
			return super.getReviewsSizeOfOneHotel(hotelID);
		} finally {
			lock.unlockRead();
		}
	}
	...
	/**
	 * Override the super getReviewsOfOneHotel
	 *
	 * @param hotelID
	 *
	 * @param num
	...
	public JSONArray getReviewsOfOneHotel(String hotelID, int num) {
		lock.lockRead();
		try {
			return super.getReviewsOfOneHotel(hotelID, num);
		} finally {
			lock.unlockRead();
		}
	}
	...
	/**
	 * Override the super getReviewSetOfOneHotel
	 *
	 * @param hotelId
	 *
	 * @return the whole review set about the given hotelId
	 * */
	@Override
	public TreeSet<Review> getReviewSetOfOneHotel(String hotelId) {
		lock.lockRead();
		try {
			return super.getReviewSetOfOneHotel(hotelId);
		} finally {
			lock.unlockRead();
		}
	}
