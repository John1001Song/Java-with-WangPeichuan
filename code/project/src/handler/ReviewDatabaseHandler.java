...
public class ReviewDatabaseHandler {
     ...
     * */
    public ArrayList displayReviewsOfWantedHotel(String hotelId) {
     ...
     * */
    public ArrayList displayReviewsOfUser(String userName) {
        ResultSet resultSet = null;
        ArrayList<String> reviewList = new ArrayList<>();
        ...
        try (Connection connection = db.getConnection();
            ...
            try {
                while (resultSet.next()) {
                    ...
                    String title = resultSet.getString("title");
                    String isRecomd = resultSet.getString("isRecomd");
                    thisReview = "<p>" + "Review ID: " + reviewId + "<br>"
                            + "Hotel ID: " + hotelId + "<br>"
                            + "User Name: " + userName + "<br>"
                            + "Title: " + title + "<br>"
                            + "Content: " + content + "<br>"
                            + "Average Rating: " + avgRating + "<br>"
                            + "Is Recomd? " + isRecomd + "<br>"
                            // put the edit and delete button here
                            + "<form action=\"/manageMyReviews?reviewId=" + reviewId + "\" method=\"post\">"
     ...
     *
     * @see #duplicateReviewId(Connection, String)
